...
class _SendOrderSheetState extends State<_SendOrderSheet> {
  ...
  final List<TextEditingController> _monthCtrls = [TextEditingController()];
  int _monthCount = 1;
          ...
          child: Form(
            ...
            child: ListView(
              ...
              children: [
                ...
                _label(
                  context,
                  _monthCount == 1 ? 'Amount (BHD)' : 'Amount per Month (BHD)',
                  icon: Icons.payments_rounded,
                  required: true,
                ),
                if (_monthCount > 1) ...[
                ...
                ...List.generate(_monthCount, (i) {
                  return Padding(
                    padding:
                        EdgeInsets.only(bottom: i < _monthCount - 1 ? 8 : 0),
                    child: TextFormField(
